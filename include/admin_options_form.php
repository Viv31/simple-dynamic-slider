...
<form action="" method="POST">
  ...
  <input type="number" name="slider_img_per_page" placeholder="Enter no of post" class="myinput" value="<?php echo esc_attr($settingDataUpdate->slider_img_per_page); ?>" required><br>
   <label>Timer(in milliseconds):</label>
  <input type="text" name="Slider_Timer" placeholder="Enter time for slider repeation" class="myinput" value="<?php echo esc_attr($settingDataUpdate->Slider_Timer); ?>" required><br>
  <label>Border Color:</label>
  <input type="color" name="border_color" class="myinput" value="<?php echo esc_attr($settingDataUpdate->border_color); ?>" >
  <br>
  <label>Border Width(in pixels):</label>
  <input type="number" name="border_width" class="myinput" value="<?php echo esc_attr($settingDataUpdate->border_width); ?>" required>
